...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('ee3-addon', 'system/user/addons/ee_custom/', 'test/ee_custom'),
            array('ee3-theme', 'themes/user/ee_custom/', 'test/ee_custom'),
            array('ee2-addon', 'system/expressionengine/third-party/ee_custom/', 'test/ee_custom'),
            array('ee2-theme', 'themes/third-party/ee_custom/', 't-est/ee_custom'),
