...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestSupport()
    {
        return array(
            ...
            array('pico-plugin', true),
            array('pico-theme', true),
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('pico-plugin', 'plugins/AwesomeNyanCat/', 'author/awesome-nyan-cat-plugin'),
            array('pico-theme', 'themes/AwesomeNyanCat/', 'author/awesome-nyan-cat-theme'),
