...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestSupport()
    {
        return array(
            ...
            array('symfony1-lib', true),
            array('symfony1-lib-vendor', true),
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('symfony1-lib', 'lib/foo/', 'test/foo'),
            array('symfony1-lib', 'lib/fooBar/', 'test/foo-bar'),
            array('symfony1-lib-vendor', 'lib/vendor/sensioLabs/', 'test/sensioLabs'),
            array('symfony1-lib-vendor', 'lib/vendor/sensioLabs/', 'test/sensio-labs'),
