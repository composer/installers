...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('blesta-plugin', 'plugins/plugin_name/', 'author/plugin_name'),
            array('blesta-gateway-merchant', 'components/gateways/merchant/gateway_name/', 'author/gateway_name'),
            array('blesta-gateway-nonmerchant', 'components/gateways/nonmerchant/gateway_name/', 'author/gateway_name'),
            array('blesta-module', 'components/modules/module_name/', 'author/module_name'),
            array('blesta-invoice-template', 'components/invoice_templates/template_name/', 'author/template_name'),
            array('blesta-report', 'components/reports/report_name/', 'author/report_name'),
